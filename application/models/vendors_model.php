...
class Vendors_model extends CI_Model {
	...
	public function insert_data($login_id)
	{
		...
		// company drag n drop csv fil details
	...
	public function get_profile($profile='')
	{
		...
		echo'<form action="<?php echo base_url();?>vendors/" method="post">';
		echo '<div style="overflow-y:auto;">';
		echo'<table border="0" cellpadding="3" cellspacing="10">';
		echo'<tr><th style="background:#999999;"> Ingredient</th><th style="background:#999999;">Unit</th><th style="background:#999999;">Measurement </th><th style="background:#999999;">Cost </th></tr>';
		
		echo '<tr><td><select name="itemname[]">';
		echo '<option> </option>';
		echo '<option value="tt">test</option>';
		echo '</select></td>';	
		echo'<td><input type="text" name="unit[]" style="width:50px;" /></td>';
		echo'<td><input type="text" name="measurement[]" style="width:50px;" /></td>';
		echo'<td><input type="text" name="cost[]" style="width:50px;" /></td>';
		echo'</tr>';
		...
		echo'</div>';
		echo'<tr><td colspan="4"><input type="submit" name="submit" class="submit" value="Add & Sync" /></td></tr>';	
		echo'</table>';
