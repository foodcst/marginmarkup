...
<div id="container">
     <?php $code = $this->input->get('code');?>  
		<div id="body">
		 ...
		 <input type="password" id="password" name="password" class="txtstyle" placeholder="Password" required>
		 <span class="error"> <?php echo form_error('password'); ?> </span>
		  <br>
		 <input type="password" id="passconf" name="passconf" class="txtstyle" placeholder="Retype Password" required>
