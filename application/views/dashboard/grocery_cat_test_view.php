...
$("body").on("click", "#addmore", function() {
    var tr = "<tr><td><input type='text' class='description' name='description[]' style='width:260px;' required/></td><td><input type='text' class='pack' name='pack[]' style='width:30px;' required/></td><td><input type='text' class='size' name='size[]' style='width:50px;' required/></td><td><select class='purchase' name='purchaseunit[]' required><option value='case'>Case </option><option value='each'>Each </option></select></td><td></td><td><select class='um' name='um[]' style='width:50px;' required><option value='ea'>EA </option><option value='oz-wt'>OZ-wt </option><option value='oz-fl'>OZ-fl </option><option value='lb'>LB (wt 160z per lb) </option><option value='galoon'>Gallon (fluid,128 fl oz per gallon) </option></select></td><td><input type='text' class='ruperpu' name='ruperpu[]' style='width:50px;' required/></td><td><input type='text' class='yield' name='yield[]' style='width:50px;' required /></td><td><input type='button' class='removebutton' id='removemore'  value='Delete' /></td></tr>";
	 $('#table').append(tr);
});
				 		     ...
				 		     <div id="tab_manage" class="tab_manage"><!--common  -->  
							   <div class="content mCustomScrollbar"> <!--scroll -->
								  ...
								  <table id="table" border="0" cellpadding="3" cellspacing="10">
									...
									<tr><td><input type="text" class="description" name="description[]" style="width:260px;" required /></td>
										<td><input type="text" class="pack" name="pack[]" style="width:30px;" required /></td>
