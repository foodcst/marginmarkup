 ...
 <div id="purveyor_container" > 
   <div id="profile">
   		<div class="head">
   			...
   			<div id="horizonttab" style="">
   				<ul id="tablist">
   					<li ><a href="#">All</a></li>
					<li ><a href="<?php echo base_url();?>grocery/freshproducts">Fresh Produce</a></li>
					<li  class="active"> <a href="<?php echo base_url();?>grocery/meat">Meat</a></li>
